...
public class TestAdmin {
    ...
    @Test
    public void testCreateClass3(){//Checks if can create class that already exist with same name and year, should be false
    ...
    @Test
    public void testCreateClass4(){//Checks if can create class for instructor that's already assigned to 2 classes, should be false
        this.admin.createClass("Class", 2017, "Instructor", 15);
    ...
    @Test
    public void testCreateClass5(){//Checks if can create class with capacity of 0, should be false
    ...
    @Test
    public void testChangeCapacity4(){//Checks if can change capacity of a class that does not exist, should be null
